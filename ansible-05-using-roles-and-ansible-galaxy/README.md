...
* First create a new EC2 instance with Ubuntu 20.04 instance image. AMI Number: ami-0aa2b7722dc1b5612
 ...
 [servers]
web_server_1 ansible_host=172.31.22.43 ansible_ssh_private_key_file=~/sam.pem ansible_user=ec2-user
web_server_2 ansible_host=172.31.17.71 ansible_ssh_private_key_file=~/sam.pem ansible_user=ubuntu
instance_image ansible_host=172.31.26.153 ansible_ssh_private_key_file=~/sam.pem ansible_user=ubuntu
```bash
...
- name: Send slack notification
  slack:
    token: "{{slack_token}}"
    msg: ' {{ inventory_hostname }} Deployed with Ansible ---> B149 DevOps' 
